...
const apiURL = import.meta.env.VITE_API_URL !== undefined && import.meta.env.VITE_API_URL !== '' ? import.meta.env.VITE_API_URL : ''; // Empty string means use same origin (Vite proxy in dev)
