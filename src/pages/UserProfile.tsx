...
import { Copy, Eye, EyeOff, Check, ArrowLeft, User } from 'lucide-react';
import { copyToClipboard } from '../utils';
import { Button } from '../components/ui/button';

export default function UserProfile() {
  const navigate = useNavigate();
  const { userAccount, isUserAuthenticated, changePassword, userLogout } = useAuth();
            ...
            <div className="px-6 py-4 border-b border-border">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="mt-1 text-sm">{userAccount.display_name || 'Not set'}</p>
                </div>
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm capitalize">
                    {userAccount.primary_auth_method === 'oauth' || userAccount.primary_auth_method === 'google'
                      ? 'Google OAuth'
                      : userAccount.primary_auth_method}
                  </p>
                </div>
              </div>
            </div>
