...
import { Brain, Trash2, Plus, Calendar } from 'lucide-react'
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[1000px] max-h-[85vh] overflow-hidden flex flex-col">
        <DialogHeader>
          ...
          <DialogDescription>
            Manage memory namespaces for AI agent learning and knowledge storage. Memory records are stored in the database with identity-based access control (not as files).
          </DialogDescription>
        </DialogHeader>
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            <span className={`px-2 py-0.5 text-xs rounded ${
                              scope === 'agent' ? 'bg-purple-100 text-purple-700 dark:bg-purple-900 dark:text-purple-300' :
                              scope === 'tenant' ? 'bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300' :
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground mb-2">
                    Unique name for your memory (letters, numbers, underscores, hyphens only)
                  </p>
                  ...
                  <div className="space-y-2">
                    ...
                    {loadingAgents ? (
                      ...
                      <div className="text-sm text-muted-foreground">
                        No agents registered. Please register an agent first.
                      </div>
                    ) : (
                      <select
                        id="memory-agent"
                      ...
                      >
                        ...
                        {agents.map((agent) => {
                          ...
                          const agentName = agent.agent_id.includes(',')
                    ...
                    <p className="text-xs text-muted-foreground">
                      Select which agent can access this memory namespace
                    </p>
                  </div>
                )}
